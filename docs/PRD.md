...
1. Should we support Google/Apple social login from day one?
2. What should the free tier limits be?
3. Do we need content moderation for user-generated courses?
4. Should schools be able to white-label the app?
5. Do we need a web-based admin panel separate from the main app?
6. Should we integrate with existing school LMS systems (Canvas, Moodle)?
7. Do we need NAPLAN alignment or just general curriculum alignment?
8. Should the Study Buddy AI have a personality/avatar?
9. Do we need a parent app or is the mentor view sufficient?
10. How do we handle students sharing inappropriate content in cheers/feedback?
